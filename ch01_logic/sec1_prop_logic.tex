...
We can form new propositions from those we already have (like those given
...
By observing the truth tables for $p\rightarrow q$, the converse, the
...
\exercise Construct the truth table of the compound proposition
